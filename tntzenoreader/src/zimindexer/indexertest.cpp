...
////////////////////////////////////////////////////////////////////////
class ParseResultPrinter : public zim::ArticleParseEventEx
{
...
////////////////////////////////////////////////////////////////////////
class EventPrinter : public zim::ArticleParseEventEx
{
  public:
    void onH1(const std::string& word, unsigned pos);
    void onH2(const std::string& word, unsigned pos);
...
////////////////////////////////////////////////////////////////////////
void process(std::istream& in, zim::ArticleParseEvent& ev)
{
  zim::ArticleParser parser(ev);
  char ch;
  while (in.get(ch))
    parser.parse(ch);
  parser.endparse();
